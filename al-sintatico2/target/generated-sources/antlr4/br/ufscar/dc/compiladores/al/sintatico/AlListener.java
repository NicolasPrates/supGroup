...
public interface AlListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link AlParser#variavel_do_registro}.
	 * @param ctx the parse tree
	 */
	void enterVariavel_do_registro(AlParser.Variavel_do_registroContext ctx);
	/**
	 * Exit a parse tree produced by {@link AlParser#variavel_do_registro}.
	 * @param ctx the parse tree
	 */
	void exitVariavel_do_registro(AlParser.Variavel_do_registroContext ctx);
	/**
