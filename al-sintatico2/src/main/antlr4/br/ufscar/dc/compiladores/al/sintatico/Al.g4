...
variavel_do_registro: IDENT ( VIRGULA IDENT)* DOIS_PONTOS tipo_basico;
identificador: ident1=IDENT (PONTO ident2+=IDENT)* dimensao ;
...
registro: REGISTROW variavel_do_registro* FIM_REGISTRO ;
